...
# Provisioning AWS EKS Cluster W/ Terraform

## Introduction

Using HashiCorps tutorial, I provisioned an EKS cluster.

## Link To Tutorial

You can find the tutorial [here](https://learn.hashicorp.com/tutorials/terraform/eks).
